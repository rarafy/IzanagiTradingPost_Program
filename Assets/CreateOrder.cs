...
namespace Create_Order
{
    public class CreateOrder : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("１階(種類)")]
        private ScrollRect typeScrollView;
        [SerializeField, Tooltip("２階(名称)")]
        private ScrollRect secondTypeScrollView;
        [SerializeField, Tooltip("３階(種類/個数)")]
        private ScrollRect thirdTypeScrollView;
        [SerializeField, Tooltip("４階(レア度)")]
        private ScrollRect fourthTypeScrollView;
        [SerializeField, Tooltip("５階(強化値)")]
        private ScrollRect fifthTypeScrollView;
        [SerializeField, Tooltip("６階(価格)")]
        private ScrollRect sixthTypeScrollView;
        [SerializeField, Tooltip("７階(詳細)")]
        private ScrollRect seventhTypeScrollView;
        [SerializeField, Tooltip("エラーパネル")]
        private GameObject ErrorPanel;

        private GameObject previousButton;

        public void SetTypeDropdown(GameObject type)
        {
            typeDropdown = type.transform.GetChild(0).GetChild(0).gameObject.GetComponent<Text>().text;
            if (previousButton) previousButton.GetComponent<Button>().interactable = true;
            previousButton = type.transform.GetChild(0).gameObject;
        ...
        public void OnListUpdate()
        {
            ...
            typeScrollView.gameObject.SetActive(false);
            secondTypeScrollView.gameObject.SetActive(true);
        }
        //--------------------------------------------------------
        public void OnSecondListCancel()
        {
            typeScrollView.gameObject.SetActive(true);
            secondTypeScrollView.gameObject.SetActive(false);
        }

        public void OnSecondListUpdate()
        {
            thirdTypeDropdown.ClearOptions();
            ...
            secondTypeScrollView.gameObject.SetActive(false);
            thirdTypeScrollView.gameObject.SetActive(true);
        }
        //--------------------------------------------------------
        public void OnThirdListCancel()
        {
            secondTypeScrollView.gameObject.SetActive(true);
            thirdTypeScrollView.gameObject.SetActive(false);
        }

        public void OnThirdListUpdate()
        {
            ...
            if (typeDropdown == "武器" || typeDropdown == "防具")
            {
                ...
                thirdTypeScrollView.gameObject.SetActive(false);
                fourthTypeScrollView.gameObject.SetActive(true);
            }
            else
            {
                thirdTypeScrollView.gameObject.SetActive(false);
                sixthTypeScrollView.gameObject.SetActive(true);
            }
        }
        //--------------------------------------------------------
        public void OnFourthListCancel()
        {
            thirdTypeScrollView.gameObject.SetActive(true);
            fourthTypeScrollView.gameObject.SetActive(false);
        }

        public void OnFourthListUpdate()
        {
            fourthTypeScrollView.gameObject.SetActive(false);
            fifthTypeScrollView.gameObject.SetActive(true);
        }
        //--------------------------------------------------------
        public void OnFifthListCancel()
        {
            fourthTypeScrollView.gameObject.SetActive(true);
            fifthTypeScrollView.gameObject.SetActive(false);
        }

        public void OnFifthListUpdate()
        {
            fifthTypeScrollView.gameObject.SetActive(false);
            sixthTypeScrollView.gameObject.SetActive(true);
        }
        //--------------------------------------------------------
        public void OnSixthListCancel()
        {
            fifthTypeScrollView.gameObject.SetActive(true);
            sixthTypeScrollView.gameObject.SetActive(false);
        }

        public void OnSixthListUpdate()
        {
            if (sixthTypeDropdown.text == "") ErrorPanel.gameObject.SetActive(true);
            else
            {
                sixthTypeScrollView.gameObject.SetActive(false);
                seventhTypeScrollView.gameObject.SetActive(true);
            }
        }
        //--------------------------------------------------------
        public void OnSeventhListCancel()
        {
            sixthTypeScrollView.gameObject.SetActive(true);
            seventhTypeScrollView.gameObject.SetActive(false);
        }
        #endregion
