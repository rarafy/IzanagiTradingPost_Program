...
public class LoginController : MonoBehaviour
{
    ...
    private void Start()
    {
        if (!panelSwitchController)
        {
            panelSwitchController = this.GetComponent<PanelSwitchController>();
        }
    ...
    private void Login()
    {
        ...
        panelSwitchController.OnLoginSucceeded();
    }
    ...
    public void Logout()
    {
        ...
        panelSwitchController.OnLogout();
    }
}
