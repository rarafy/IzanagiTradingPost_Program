...
public class Username_SaverForAdmin : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("出品者(ユーザ名)/ID of 注文作成ページ")]
    private InputField usernameInputField_C;
    ...
    private void UserNameAsync()
    {
        if (PlayerPrefs.HasKey(userNamePrefKey))
        {
            ...
            usernameInputField_C.text = PlayerPrefs.GetString(userNamePrefKey);
        }
    }
    ...
    [SerializeField, Tooltip("出品者/URL of 注文作成ページ")]
    private InputField userURLInputField_C;
    ...
    private void UserURLAsync()
    {
        if (PlayerPrefs.HasKey(userURLPrefKey))
        {
            ...
            userURLInputField_C.text = PlayerPrefs.GetString(userURLPrefKey);
        }
    }
