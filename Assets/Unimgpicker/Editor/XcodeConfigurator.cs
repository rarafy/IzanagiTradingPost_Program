...
namespace Kakera.Unimgpicker
{
    public class XcodeProjectConfigurator
    {
        ...
        static void ConfigurePlist(string buildPath, string plistPath)
        {
            ...
            string path = Path.Combine(buildPath, plistPath);

            plist.ReadFromFile(path);

            string descriptionFilePath = Path.Combine(Application.dataPath, "Unimgpicker/Editor/NSPhotoLibraryUsageDescription.txt");
